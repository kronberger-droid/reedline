...
impl Helix {
    ...
    fn handle_normal_key(&mut self, c: char) -> ReedlineEvent {
        ...
        match c {
            ...
            'w' => self.motion_event(word(WordKind::Word, WordEdge::Start, Direction::Forward)),
            'W' => self.motion_event(word(
                WordKind::LongWord,
                WordEdge::Start,
                Direction::Forward,
            )),
            'e' => self.motion_event(word(WordKind::Word, WordEdge::End, Direction::Forward)),
            'E' => self.motion_event(word(WordKind::LongWord, WordEdge::End, Direction::Forward)),
            'b' => self.motion_event(word(WordKind::Word, WordEdge::Start, Direction::Backward)),
            'B' => self.motion_event(word(
                WordKind::LongWord,
                WordEdge::Start,
                Direction::Backward,
            )),
...
mod test {
    ...
    fn count_repeats_motion() {
        ...
        let target = word(WordKind::Word, WordEdge::Start, Direction::Forward);
        assert_eq!(
            helix.parse_event(chr('w')),
